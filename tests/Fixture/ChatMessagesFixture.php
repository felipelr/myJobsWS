...
class ChatMessagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'msg_from' => ['type' => 'string', 'length' => 50, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_indexes' => [
