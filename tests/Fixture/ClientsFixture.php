...
class ClientsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'genre' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => 'MASCULINO', 'collate' => 'latin1_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'date_birth' => '2019-06-26',
                'genre' => 'Lorem ipsum dolor sit amet',
                'latitude' => 1,
                'longitude' => 1,
                'created' => '2019-06-26 19:33:23',
                'modified' => '2019-06-26 19:33:23',
                'active' => 1
            ],
        ];
        parent::init();
