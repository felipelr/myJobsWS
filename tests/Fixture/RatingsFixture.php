...
class RatingsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            ...
            'ratings_user_id_fk' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
        ],
        '_constraints' => [
            ...
            'ratings_user_id_fk' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'grade' => 1,
                'indication' => 1,
                'created' => '2020-02-05 16:14:33',
                'modified' => '2020-02-05 16:14:33'
            ],
        ];
        parent::init();
    }
