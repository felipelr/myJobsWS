...
class ServicesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'subcategories_id_fk' => ['type' => 'index', 'columns' => ['subcategory_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'subcategories_id_fk' => ['type' => 'foreign', 'columns' => ['subcategory_id'], 'references' => ['subcategories', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
