...
class CallsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'CALL_USER_ID_FK' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
        ...
        '_constraints' => [
            ...
            'CALL_USER_ID_FK' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-09-16 10:13:33',
                'modified' => '2019-09-16 10:13:33'
            ],
        ];
        parent::init();
    }
