...
class ProfessionalsController extends AppController
{
    ...
    { 
        ...
        "   SELECT p.name AS nome, p.description AS descricao, ps.rating AS avaliacao, ps.amount_ratings AS qtdeAvaliacoes, 'info: \"87 Atendimentos realizados,  0.82km de você\"' AS info, photo AS imagem FROM professionals AS p 
